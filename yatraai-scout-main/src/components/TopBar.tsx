...
const TopBar = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-[260px] h-14 z-30 flex items-center justify-end px-6 gap-3 glass-card border-b border-border/50 backdrop-blur-md">
      {/* Theme Toggle */}
      <button
        onClick={toggleTheme}
